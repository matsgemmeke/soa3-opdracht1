...
public class WeekendTicketRuleTest {
    ...
    public void testGroupDiscount() {
        MovieScreening movieScreeningOne = new MovieScreening(movie, LocalDateTime.of(2019, 2, 1, 0, 0), 10.0);
        MovieScreening movieScreeningTwo = new MovieScreening(movie, LocalDateTime.of(2019, 2, 1, 0, 0), 10.0);
        MovieScreening movieScreeningThree = new MovieScreening(movie, LocalDateTime.of(2019, 2, 1, 0, 0), 10.0);
        MovieScreening movieScreeningFour = new MovieScreening(movie, LocalDateTime.of(2019, 2, 1, 0, 0), 10.0);
        MovieScreening movieScreeningFive = new MovieScreening(movie, LocalDateTime.of(2019, 2, 1, 0, 0), 10.0);
        MovieScreening movieScreeningSix = new MovieScreening(movie, LocalDateTime.of(2019, 2, 1, 0, 0), 10.0);
